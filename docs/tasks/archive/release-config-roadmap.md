# Archived task detail — release-config-roadmap.md

> Moved from [`docs/tasks/release-config-roadmap.md`](../release-config-roadmap.md) on 2026-08-29 to keep the live file lean.
