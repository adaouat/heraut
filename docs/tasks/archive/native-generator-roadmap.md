# Archived task detail — native-generator-roadmap.md

> Moved from [`docs/tasks/native-generator-roadmap.md`](../native-generator-roadmap.md) on 2026-08-29 to keep the live file lean.
> Phase 3 (the one deferred, not-started item) stays in the live file as a pointer;
> everything below is `Done`. See the live file's "Progress at a glance" table for the
