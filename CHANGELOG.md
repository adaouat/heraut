...
<!-- heraut-release: v0.70.0 -->
## [0.70.0](https://github.com/adaouat/heraut/compare/v0.69.1..v0.70.0) - 2026-09-25

### 📚 Documentation

- *(readme)* Document the packslip-verified mise install, keep github: as fallback - ([bf2182f](https://github.com/adaouat/heraut/commit/bf2182fbc34a596fad047d83cd22588e82787903)) by @bchatard


### ⚙️ Miscellaneous Tasks

- *(release)* Publish a signed packslip manifest alongside each release - ([dd9be6f](https://github.com/adaouat/heraut/commit/dd9be6f08ba3b08bd28dd8e99d7d7c00db0f52db)) by @bchatard

<!-- heraut-release: v0.69.1 -->
## [0.69.1](https://github.com/adaouat/heraut/compare/v0.69.0..v0.69.1) - 2026-09-25

### ⚙️ Miscellaneous Tasks

- *(release)* Normalize manual version override before GoReleaser build - ([6302dfd](https://github.com/adaouat/heraut/commit/6302dfdec9df668c111ab5042c5a714c6d0c90e0)) by @bchatard
...
- *(config,pipeline,app)* Stage hook-declared files into changelog commit (T295-T298) - ([d6890c0](https://github.com/adaouat/heraut/commit/d6890c0021be61ae9d8b0cfb4a478c003b5a9fcb)) by @bchatard


### 🐛 Bug Fixes

- *(pipeline)* Stage-aware nothing-to-commit warning, labeled hook render errors - ([00ac5f6](https://github.com/adaouat/heraut/commit/00ac5f6ce6b0a0654ea5c587e97ff30f8d35772e)) by @bchatard


### 📚 Documentation

- *(roadmap)* File Phase 51 and T295-T300 for hook file staging - ([e4f7afd](https://github.com/adaouat/heraut/commit/e4f7afd4f5507faf0e6fc0778cd69d9c836ef6c4)) by @bchatard

- Commit hook-file-staging design, extend ADR-0053 hooks - ([b78fed1](https://github.com/adaouat/heraut/commit/b78fed10bd723344c6c1f78fef7132b9823880b2)) by @bchatard

- ADR-0061, hook stage field, epic completion notes (T300) - ([e8fd3f8](https://github.com/adaouat/heraut/commit/e8fd3f8be9d03c6a2728cd09f8b691ba02781f9b)) by @bchatard

- Stage only stages into a commit that actually happens this run - ([8756368](https://github.com/adaouat/heraut/commit/875636817b7b780bb71f9da6622eba9d5a53bdfb)) by @bchatard


### 🧪 Testing

- *(cmd)* Real-git-repo proof of hook-declared file staging (T299) - ([c1d717c](https://github.com/adaouat/heraut/commit/c1d717cf872e2c8eeb57de781d06a551ca47f408)) by @bchatard

- *(pipeline)* Prove combined post_bump/pre_changelog stage reaches git add - ([1fa09df](https://github.com/adaouat/heraut/commit/1fa09df6b910f6d82c84354e36e8c5cdf1f7a420)) by @bchatard

<!-- heraut-release: v0.67.0 -->
## [0.67.0](https://github.com/adaouat/heraut/compare/v0.66.0..v0.67.0) - 2026-09-14

### 🚀 Features

- *(app)* Propagate effective rendering.trailers to content drivers - ([e799399](https://github.com/adaouat/heraut/commit/e799399721455b335e91f836588b789dd2d7049e)) by @bchatard

- *(app)* Merge built-in Co-Authored-By default into effectiveTrailers, close T287 (ADR-0058) - ([53eb544](https://github.com/adaouat/heraut/commit/53eb544ac282b8502c7208d531456b7ae1bd6499)) by @bchatard

- *(config)* Add rendering.trailers schema and validation - ([7d758be](https://github.com/adaouat/heraut/commit/7d758be768b9fd936a0d303a43d3d6fd4890928c)) by @bchatard

- *(config)* Add DefaultTrailers built-in Co-Authored-By rule - ([e85564f](https://github.com/adaouat/heraut/commit/e85564f01d004c2a77d41dc0200a3560aeb8e5d9)) by @bchatard

- *(generators/native)* Render commit footers via rendering.trailers, close T284 (ADR-0057) - ([cf5e071](https://github.com/adaouat/heraut/commit/cf5e0715e43759513684ea48752a339e01f11420)) by @bchatard


### 🐛 Bug Fixes

- *(config)* Correct rendering.commit.trailers to rendering.templates.commit.trailers (ADR-0060) - ([3110bc0](https://github.com/adaouat/heraut/commit/3110bc04c1de7f152937170573badc4dfbe596f6)) by @bchatard


### 🚜 Refactor

- *(config)* Move rendering.trailers to rendering.commit.trailers (ADR-0060), close T293 - ([df9bb56](https://github.com/adaouat/heraut/commit/df9bb56de5f4ca43ac1625f4eb7c3e17c53b0b8f)) by @bchatard

- *(generators/native)* Namespace rendering.templates blocks into release.*/commit.* (ADR-0059), close T290 - ([e5204f7](https://github.com/adaouat/heraut/commit/e5204f7a3359f2bc76467a686e2997efa0fa538f)) by @bchatard


### 📚 Documentation

- *(adr)* Accept ADR-0057, close T283 — rendering.trailers - ([4a33560](https://github.com/adaouat/heraut/commit/4a33560c42994734986cbded9814bdeaa7bf0be2)) by @bchatard

- *(adr)* Accept ADR-0058, close T286 — default Co-Authored-By trailer - ([b700924](https://github.com/adaouat/heraut/commit/b700924584cdd2f077e223639d69fe46a6271cd3)) by @bchatard

- *(adr)* Namespace rendering.templates into release.*/commit.* (ADR-0059), close T289 - ([7e303ae](https://github.com/adaouat/heraut/commit/7e303ae46d19a7c2432934f39c507e57a8ba0337)) by @bchatard

- *(adr)* Move rendering.trailers to rendering.commit.trailers (ADR-0060), close T292 - ([97c5e84](https://github.com/adaouat/heraut/commit/97c5e84010e91422847fd0a889e807a069fca0e2)) by @bchatard

- Rendering.trailers spec, schema, sample config, guide, close T285 (ADR-0057) - ([f776d50](https://github.com/adaouat/heraut/commit/f776d50dc75b85106a46fe04f86dfe46f034f880)) by @bchatard

- Co-Authored-By built-in default — spec, sample config, guide, close T288 (ADR-0058) - ([c5dba17](https://github.com/adaouat/heraut/commit/c5dba17d841dcf8da1ba4e1dae5e161bdb162dda)) by @bchatard

- Namespace rendering.templates docs to release.*/commit.* (ADR-0059), close T291 - ([09802c3](https://github.com/adaouat/heraut/commit/09802c30bd24cb64efd0fc0bc88b75f096de2b21)) by @bchatard

- Move rendering.trailers docs to rendering.commit.trailers (ADR-0060), close T294 - ([1b0b38b](https://github.com/adaouat/heraut/commit/1b0b38bc77d411902d48b0d127104cb4990ecb1e)) by @bchatard


### ⚙️ Miscellaneous Tasks

- *(config)* Block the session-link commit trailer via commits.rules - ([0a5a9b8](https://github.com/adaouat/heraut/commit/0a5a9b8544510c2f384cc8d1a32636a9dcc57c93)) by @bchatard

<!-- heraut-release: v0.66.0 -->
## [0.66.0](https://github.com/adaouat/heraut/compare/v0.65.0..v0.66.0) - 2026-09-13

### 🚀 Features

- *(app)* Enforce commits.rules in VerifyCommit, close T281 (ADR-0056) - ([afc767d](https://github.com/adaouat/heraut/commit/afc767d2682016749e1427e3741f187090418b21)) by @bchatard

- *(config)* Add commits.rules schema and validation (T281, ADR-0056) - ([67c9248](https://github.com/adaouat/heraut/commit/67c92487c28f16105d788689ddf9d320d89832e2)) by @bchatard

- *(pipeline)* Thread active env into hook template context, close T278 - ([678c646](https://github.com/adaouat/heraut/commit/678c646700ba7e4868c4cb4aba415e9b76589341)) by @bchatard


### 📚 Documentation

- *(adr)* Accept ADR-0055, close T277 — env hook template variable decision - ([df3a393](https://github.com/adaouat/heraut/commit/df3a39380109408f73bd63d47571eeae17e0b117)) by @bchatard

- *(adr)* Accept ADR-0056, close T280 — commits.rules commit-message pattern rules - ([9cf2bc7](https://github.com/adaouat/heraut/commit/9cf2bc7f9dc2703c59f25cce8f82a9fbbac66396)) by @bchatard

- *(roadmap)* Add phase 45 — env hook template variable - ([5a7b264](https://github.com/adaouat/heraut/commit/5a7b2644c2dd5baa1c41934866fe4602058bac83)) by @bchatard

- Document {{ .Env }} hook template variable, close T279 - ([611eacf](https://github.com/adaouat/heraut/commit/611eacfb039c53bcd18cfbdf200f205227be20c6)) by @bchatard

- Add {{ .Env }} to remaining hook template-variable references (T279) - ([e0008c5](https://github.com/adaouat/heraut/commit/e0008c551aaf5c7772fd175cc60f48a73bb294ce)) by @bchatard

- Document commits.rules, close T282 (ADR-0056) - ([1ec0b22](https://github.com/adaouat/heraut/commit/1ec0b224d91d050910a5b19d4c5c08cd9640c2fd)) by @bchatard

<!-- heraut-release: v0.65.0 -->
## [0.65.0](https://github.com/adaouat/heraut/compare/v0.64.0..v0.65.0) - 2026-09-12

### 🚀 Features

- *(pipeline)* Select hook shell per GOOS, close T275 - ([844f865](https://github.com/adaouat/heraut/commit/844f865aba1f335b72b12afa932a4225b6243ee5)) by @bchatard


### 📚 Documentation

- *(adr)* Accept ADR-0054, close T274 — windows hook shell decision - ([e727ba5](https://github.com/adaouat/heraut/commit/e727ba5e9b1c34367266c63a1f25dec1c92f7580)) by @bchatard

- *(roadmap)* Add phase 44 — windows hook execution - ([a457f7c](https://github.com/adaouat/heraut/commit/a457f7c00693bffecc2fd24469f0190436c79494)) by @bchatard

- Add release pipeline and hook-position guide - ([8bf0e65](https://github.com/adaouat/heraut/commit/8bf0e65c825ca75eef57b577174cbab0f20ba3bf)) by @bchatard

- Sync hooks docs to per-OS shell execution, close T276 - ([b658750](https://github.com/adaouat/heraut/commit/b6587504ea9ed88e89086175b9a9ed688d28eafe)) by @bchatard

<!-- heraut-release: v0.64.0 -->
## [0.64.0](https://github.com/adaouat/heraut/compare/v0.63.0..v0.64.0) - 2026-09-11

### 🚀 Features

- *(cmd)* [**breaking**] Rename --version/--build override flags to --set-version/--set-build-id (T263) - ([bad4968](https://github.com/adaouat/heraut/commit/bad4968ad07fdb33a2290382b7e1acb3a806dcb4)) by @bchatard

- *(cmd)* [**breaking**] Scope CLI flags to commands that use them, not root - ([e048b82](https://github.com/adaouat/heraut/commit/e048b82c8dc7eb3e43a85367226916681903955f)) by @bchatard

- *(config)* Add hooks schema for release lifecycle commands (T267) - ([e533570](https://github.com/adaouat/heraut/commit/e5335701fce56b360d4d0a3718337a37871a6743)) by @bchatard

- *(pipeline)* Add hook execution helper via sh -c (T268) - ([e532e13](https://github.com/adaouat/heraut/commit/e532e13399877f3acb0e64074357b6d25610924a)) by @bchatard

- *(pipeline)* Wire pre_release/post_release hooks per platform (T270) - ([ee63143](https://github.com/adaouat/heraut/commit/ee63143d06856c7ec5c3e9c6c54fc5aeefa56893)) by @bchatard

- *(pipeline)* Render all six hooks during --dry-run (T271) - ([908a322](https://github.com/adaouat/heraut/commit/908a322d666c709092019b5041ca2b7e22bfda70)) by @bchatard

- *(pipeline,cmd)* Wire post_bump/pre_changelog/pre_tag/post_tag hooks (T269) - ([56e8908](https://github.com/adaouat/heraut/commit/56e8908eea3f69dd08093637ccbb1c3a462c05d8)) by @bchatard


### 🐛 Bug Fixes

- *(pipeline)* Use `--set-version` instead of `--version` - ([cb8deb4](https://github.com/adaouat/heraut/commit/cb8deb4aa9fb1e3fee3d9b0cc91fec269d28fd1b)) by @bchatard


### 📚 Documentation

- *(roadmap)* File Phase 43 and T267-T273 for release lifecycle hooks - ([8fcd0e1](https://github.com/adaouat/heraut/commit/8fcd0e1da5c4403e56ba082ee8255eb9d4dfe42c)) by @bchatard

- Commit release-hooks design, supersede exploration notes - ([d53c447](https://github.com/adaouat/heraut/commit/d53c447c52455c2dfd8aa3fee7b1c80b0a577424)) by @bchatard

- Add ADR-0053 and hooks reference, close release-hooks epic (T273) - ([4721571](https://github.com/adaouat/heraut/commit/4721571bad84fe1f38120488d80ab5e57e352d9c)) by @bchatard


### 🧪 Testing

- *(cmd)* Real-git-repo integration test for hook execution (T272) - ([82265b3](https://github.com/adaouat/heraut/commit/82265b38e8bfdc735c48da2c1637465dbeed9f59)) by @bchatard

<!-- heraut-release: v0.63.0 -->
## [0.63.0](https://github.com/adaouat/heraut/compare/v0.62.1..v0.63.0) - 2026-09-10

### 🚀 Features

- *(generators/native)* Credit every PR a first-time contributor opened - ([bdf5146](https://github.com/adaouat/heraut/commit/bdf514690b67bc153b41c1433b779cfb94213f3c)) by @bchatard

- *(versioning)* Add configurable per-commit bump-level overrides - ([9d18dbb](https://github.com/adaouat/heraut/commit/9d18dbb09baff76f3330f305b7784152157cb20c)) by @bchatard

<!-- heraut-release: v0.62.1 -->
## [0.62.1](https://github.com/adaouat/heraut/compare/v0.62.0..v0.62.1) - 2026-09-09

### 🐛 Bug Fixes

- *(generators/native)* Bound oldest scoped release against true prev tag - ([ca3baad](https://github.com/adaouat/heraut/commit/ca3baad140ffab46e74aa26d488fb8842eeee95f)) by @bchatard

- *(pipeline)* Run GPG-signing git calls through an interactive runner - ([1b6245e](https://github.com/adaouat/heraut/commit/1b6245e0d3d8218667679770e2e6bcd273f6892d)) by @bchatard

- *(scaffold)* Live-validate wizard fields config.Validate later rejects - ([63411bf](https://github.com/adaouat/heraut/commit/63411bf3ec4e0e871dd1225408c1c1e7710e75ee)) by @bchatard


### 🚜 Refactor

- *(versioning/tagfmt)* Bundle env/version/build into a Tokens struct - ([53b501f](https://github.com/adaouat/heraut/commit/53b501f4b6212069b0d485922d78aff8103d38c6)) by @bchatard


### 📚 Documentation

- *(roadmap)* Add Phase 37/38 for version-bump and contributor gaps - ([13cc39d](https://github.com/adaouat/heraut/commit/13cc39d2c9465cd2fd73248f6f1253478d16d626)) by @bchatard


### ⚙️ Miscellaneous Tasks

- *(release)* Pin goreleaser to 2.18.0 - ([bf2069d](https://github.com/adaouat/heraut/commit/bf2069dc1b07f5405161e0bc8694ff559e2d8675)) by @bchatard

<!-- heraut-release: v0.62.0 -->
## [0.62.0](https://github.com/adaouat/heraut/compare/v0.61.0..v0.62.0) - 2026-08-31

### 🚀 Features

- *(generators/native)* Add visual separator before footer - ([8197117](https://github.com/adaouat/heraut/commit/8197117c1207f3481cf359e15093290cd97f2f7f)) by @bchatard

<!-- heraut-release: v0.61.0 -->
## [0.61.0](https://github.com/adaouat/heraut/compare/v0.60.0..v0.61.0) - 2026-08-31

### 🚀 Features

- *(generators/native)* Split footer block, always refresh preamble - ([f308c40](https://github.com/adaouat/heraut/commit/f308c406de303967504585f5dbaa612413ca6217)) by @bchatard

<!-- heraut-release: v0.60.0 -->
## [0.60.0](https://github.com/adaouat/heraut/compare/v0.59.0..v0.60.0) - 2026-08-31

### 🚀 Features

- *(generators/native)* Add title/subtitle document-level template blocks - ([fe13795](https://github.com/adaouat/heraut/commit/fe13795fd96ae978f6d4f246061060a0cf4b360b)) by @bchatard

- *(generators/native)* Extend title/subtitle blocks to release notes - ([69692fb](https://github.com/adaouat/heraut/commit/69692fb85279085564d62824534baa45e1ed8670)) by @bchatard

- *(generators/native)* Default footer credits heraut with version + timestamp - ([a8d243e](https://github.com/adaouat/heraut/commit/a8d243ebf5177e493b7501748d8aae67027943ed)) by @bchatard


### 🐛 Bug Fixes

- *(generators/native)* Correct stale comments and redundant error wraps - ([b5e9662](https://github.com/adaouat/heraut/commit/b5e96620bfdf1a0b930f77334ba4fbf39f9657b5)) by @bchatard

- *(generators/native)* Null empty/whitespace overrides for every block - ([dc29c50](https://github.com/adaouat/heraut/commit/dc29c50f8450ad249eff5dc42c3f81eb10d09719)) by @bchatard


### 🚜 Refactor

- *(generators/native)* Rename header block to release_header, release-notes to release_notes - ([a4380f1](https://github.com/adaouat/heraut/commit/a4380f11751478882fae02cdf2805d6d1ddd6ada)) by @bchatard


### 📚 Documentation

- *(cmd)* Drop stale generator-choice framing from --regenerate-changelog help - ([0cffdcf](https://github.com/adaouat/heraut/commit/0cffdcf8f1af07133f4b91ec0709e0009ee5f37b)) by @bchatard

- *(guides)* Fix title/subtitle worked example and link the guide from the index - ([645c2d6](https://github.com/adaouat/heraut/commit/645c2d693a180f8c86d65c85b962a248636a21b0)) by @bchatard

- *(roadmap)* Close out Phase 30 — title/subtitle template blocks - ([33daad3](https://github.com/adaouat/heraut/commit/33daad384d48d5ccecef29ad6cc1ccd4c700a014)) by @bchatard

- *(roadmap)* Correct Phase 30 note, file Phase 31 for the parked precedence gap - ([2744990](https://github.com/adaouat/heraut/commit/2744990ae24b15f912159100ff9404c582e6e575)) by @bchatard

- *(roadmap)* File and resolve T250 design spike for Phase 31 - ([ba5c6bd](https://github.com/adaouat/heraut/commit/ba5c6bdb802952dae7f55b6925a09e172cd875e9)) by @bchatard

- *(roadmap)* Close out T251 and Phase 31 - ([f2eb089](https://github.com/adaouat/heraut/commit/f2eb0893ad6fc5d72d485506ac8433931e93a19b)) by @bchatard

- *(specs)* Drop residual multi-generator framing - ([b5fe601](https://github.com/adaouat/heraut/commit/b5fe601f457f432d7705fde1de2ccdabf0d94eb7)) by @bchatard

- *(tasks)* Archive completed dedicated-roadmap task detail - ([27be298](https://github.com/adaouat/heraut/commit/27be29887ede557ed53ba5b58f7365672894003f)) by @bchatard

- *(tasks)* Archive roadmap.md's closed phases (348K -> 20K) - ([d94a216](https://github.com/adaouat/heraut/commit/d94a2163819144c08d37a5776a66246d040fc460)) by @bchatard

- Document title/subtitle blocks and the header/release-notes rename - ([1fb5648](https://github.com/adaouat/heraut/commit/1fb56485075451ef17992fd0bafc4ac58dcae85f)) by @bchatard

- Commit design spec + plan for changelog title/subtitle blocks - ([f4fe321](https://github.com/adaouat/heraut/commit/f4fe321ad374d6607a8923ead1bb62d9583e3393)) by @bchatard

- Fix stale block names, broken anchors, and sample examples - ([6d45b4c](https://github.com/adaouat/heraut/commit/6d45b4c3907ddff102e18e1d8a59ac84e0e12311)) by @bchatard

- Rework README for a user-first pitch, trim reference tables - ([ec1a10a](https://github.com/adaouat/heraut/commit/ec1a10a65ae2c35511f0562013c19e1b0915f9cc)) by @bchatard


### 🧪 Testing

- *(config)* Cover title/subtitle/release_header in schema fixtures - ([6c6e527](https://github.com/adaouat/heraut/commit/6c6e527db5193ae1b4564352b9320c2dc90e770c)) by @bchatard
...
## [0.51.1](https://github.com/adaouat/heraut/compare/v0.51.0..v0.51.1) - 2026-07-19

### 🐛 Bug Fixes

- *(pipeline)* Populate ambient LinkContext Owner/Repo for native enrichment - ([7ccd80e](https://github.com/adaouat/heraut/commit/7ccd80e56c9d0de2cf7f2a8cf6e1bfa0e4c3cb19)) by @bchatard
...
- *(generators/native)* Resolve commit-author handle (GitHub) - ([b0b8aca](https://github.com/adaouat/heraut/commit/b0b8aca53bc8bc035ef6fc349d1ef94146cdfe30)) by @bchatard

- *(generators/native)* Carry commit-author handle onto commits - ([038f25e](https://github.com/adaouat/heraut/commit/038f25ee3214e61371243f64408ea0ec53c22870)) by @bchatard

- *(generators/native)* Credit the commit author on commit lines - ([afe8d0d](https://github.com/adaouat/heraut/commit/afe8d0d135fb52c98e017856b9c81ab6be4a769b)) by @bchatard


### 📚 Documentation

- *(adr)* 0039 commit-author attribution; spec, roadmap, follow-ups - ([ef3b050](https://github.com/adaouat/heraut/commit/ef3b050661c08692ac7d195c87f6c5bc8d452afd)) by @bchatard

- *(roadmap)* Correct the Phase 2.10 golden note - ([79f696b](https://github.com/adaouat/heraut/commit/79f696b6efbb36e0451bbc4962a54d9c80a5fde4)) by @bchatard

- Commit-author attribution design (native, GitHub-first) - ([2dbd5c4](https://github.com/adaouat/heraut/commit/2dbd5c49bc656966aca33a876444f1e356d8e1a1)) by @bchatard

- Commit-author attribution implementation plan - ([3a0346d](https://github.com/adaouat/heraut/commit/3a0346d3bcdb482d51fb5a5b30003c5d2533567e)) by @bchatard
...
- *(cmd)* --regenerate / --regenerate-changelog flags for native changelog - ([9df9683](https://github.com/adaouat/heraut/commit/9df9683c9daae4e1a38cace1f40b3faaa80191dd)) by @bchatard

- *(generators/native)* Changelog splice engine (anchors) - ([a48dea8](https://github.com/adaouat/heraut/commit/a48dea84e985dfa6d2fcf62f10d215e720fb022e)) by @bchatard

- *(generators/native)* Incremental changelog with --regenerate rebuild - ([ca86d55](https://github.com/adaouat/heraut/commit/ca86d558adb34014cd5ba23742bb44e4be118b02)) by @bchatard

- *(pipeline)* Warn on GitLab full changelog regeneration - ([382a422](https://github.com/adaouat/heraut/commit/382a422cb812814d0d5c30c3a979e31344cbe1b5)) by @bchatard


### 🐛 Bug Fixes

- *(generators/native)* Route unlabeled types into the Other catch-all - ([7145b94](https://github.com/adaouat/heraut/commit/7145b9400eb967c632f496a72a6c996c3413f971)) by @bchatard

- *(generators/native)* Check anchors before enriching; name both regenerate flags - ([3851114](https://github.com/adaouat/heraut/commit/38511143aa68b976d45b92276edf01f16c3fe799)) by @bchatard


### 📚 Documentation

- *(adr)* 0038 incremental changelog; specs, roadmap, CI migration - ([cb0c796](https://github.com/adaouat/heraut/commit/cb0c7962bc89b743b28be831395cf6b95183e6c2)) by @bchatard

- Incremental changelog generation design (native) - ([f272286](https://github.com/adaouat/heraut/commit/f2722860f71471a2c449b763eff214791add715c)) by @bchatard

- Add CI migration handling to incremental changelog spec - ([5de833a](https://github.com/adaouat/heraut/commit/5de833a9fa9a7f9e983ee809433144438e95e5a7)) by @bchatard

- Incremental changelog implementation plan - ([d2be9ad](https://github.com/adaouat/heraut/commit/d2be9adb50c1f71477eddc2dcb4d292735359aa3)) by @bchatard

- Correct full-regen enrichment cost (per-section, not global) - ([e603f66](https://github.com/adaouat/heraut/commit/e603f66e37891e3f22f53e547de637d7678f867b)) by @bchatard


### ⚙️ Miscellaneous Tasks

- Dogfood the native generator for heraut's own changelog + notes - ([696e6d7](https://github.com/adaouat/heraut/commit/696e6d79ac4ef6e23de9edfe7d084706d9174dbf)) by @bchatard


### 💼 Other

- *(deps)* Bump Go to 1.26.5 and goldmark to 1.7.17 (security) - ([e6619e2](https://github.com/adaouat/heraut/commit/e6619e2ba519b4ac982f7e5cc803f0a7ae50191c)) by @bchatard

- *(deps)* Pin go 1.26.5 in the mise lockfile - ([17b5627](https://github.com/adaouat/heraut/commit/17b5627dabbbd58bbc9849fb528c19e8d907f705)) by @bchatard
...
- Init project - ([7f15bce](https://github.com/adaouat/heraut/commit/7f15bce85a2c0ad2a1bfa7e08a0bf4afb58fb61a)) by @bchatard
<!-- heraut-footer -->

---
_Generated by [heraut](https://github.com/adaouat/heraut) v0.70.0 at 12:17 on 2026-09-25._
