...
func TestRenderPostamble_ChangelogDefault(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, "\n_Generated by [heraut](https://github.com/adaouat/heraut) 1.2.3 at 12:00 on 2024-01-15._\n", out)
}
...
func TestRenderPostamble_FileWinsOverNullFooterSnippet(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, "\nFROM FILE\n", out, "the template file wins over a null footer snippet override")
}
